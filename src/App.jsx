...
import {
  ...
  TweakSelect, TweakRadio, TweakToggle,
} from './tweaks-panel';
  ...
  return (
    <div style={{ position: 'fixed', bottom: isMobile ? 14 : 24, right: isMobile ? 14 : 24, left: isMobile ? 14 : 'auto', zIndex: 70, display: 'flex', flexDirection: isMobile ? 'row' : 'column', gap: 10, alignItems: isMobile ? 'stretch' : 'flex-end', justifyContent: isMobile ? 'space-between' : 'flex-start' }}>
      <a href="#" style={{
        ...
        <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/><path d="M12 2C6.477 2 2 6.477 2 12c0 1.768.461 3.427 1.264 4.871L2 22l5.266-1.249A9.953 9.953 0 0012 22c5.523 0 10-4.477 10-10S17.523 2 12 2zm0 18.18a8.16 8.16 0 01-4.162-1.138l-.298-.177-3.088.724.748-2.983-.194-.307A8.154 8.154 0 013.82 12 8.18 8.18 0 0112 3.82 8.18 8.18 0 0120.18 12 8.18 8.18 0 0112 20.18z"/></svg>
...
export default function App() {
  ...
  const pal = PALETTES[tweaks.palette] || PALETTES.clasico;
